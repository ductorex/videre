"""Structural inspection of the flat text_rendering pipeline — no pixels.
...
from videre.core.text_rendering.glyph_partition import GlyphLine
...
_SIZE = 20
# Three RTL Arabic letters (raw, like test_caret's ARAB sample).
ARB = "عرب"
